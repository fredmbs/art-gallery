...
public abstract class Applic extends Applet implements ActionListener {
	...
	// --------------------------------------------------------------------------
	public Node node(Program prog, String text, int xPos, int yPos) {
		Assertion.test(network != null, "network not initialized");
		return new Node(network, prog, text, xPos, yPos);
	}

	// --------------------------------------------------------------------------
	// create new node in network (without visualization information)
	// --------------------------------------------------------------------------
	public Node node(Program prog) {
		Assertion.test(network != null, "network not initialized");
		return new Node(network, prog);
	}

	// --------------------------------------------------------------------------
	// link two nodes by channel
	// --------------------------------------------------------------------------
	public void link(Node sender, Node receiver) {
		Assertion.test(network != null, "network not initialized");
	...
	// --------------------------------------------------------------------------
	public void link(Node sender, Node receiver, Selector s) {
		Assertion.test(network != null, "network not initialized");
